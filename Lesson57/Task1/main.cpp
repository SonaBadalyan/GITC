...
int main()
{
    ...
    std::sort(vec.begin(), vec.end(), byPower);
    ...
    std::sort(vec.begin(), vec.end(), byYears);
    ...
    std::sort(vec.begin(), vec.end(), byVolume);
    ...
    std::sort(vec.begin(), vec.end(), byPrice);
    ...
    std::sort(vec.begin(), vec.end(), byWeight);
