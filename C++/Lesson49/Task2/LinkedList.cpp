...
bool LinkedList<T>::remove(int index)
{
    ...
    {
        throw MyOutOfBoundException("Trying to remove from the invalid index.", index, 0, m_length);
    }
...
T LinkedList<T>::operator[](int index)
{
    if (index < 0 || index > m_length)
    {
        throw MyOutOfBoundException("Trying to access from the invalid index.", index, 0, m_length);
    }
...
bool LinkedList<T>::insert(int index, T val)
{
    if (index < 0 && index > m_length)
    {
        throw MyOutOfBoundException("Trying to insert from the invalid index.", index, 0, m_length);
    }
