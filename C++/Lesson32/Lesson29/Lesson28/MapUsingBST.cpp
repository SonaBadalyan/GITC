...
class Map
{
    ...
    private:
        ...
        void add(int key, int value, Node* temp)
        {
            if(temp == nullptr)
            {
        ...
        bool deleteNode(int key, Node* startNode, bool overloaded)
        {
        ...
        bool deleteNode(int key, Node* startNode)
        {
            Node* temp = find(startNode, key, true);
        ...
        Node* find(Node* temp, int key, bool overloaded)
        {
            if (temp == nullptr)
            {
                return nullptr;
        ...
        bool findByValue(Node* temp, int value)
        {
            bool leftFound;
            bool rightFound;
